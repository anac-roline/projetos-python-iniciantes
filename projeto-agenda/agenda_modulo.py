...
Módulo que possui funções para carregar o dicionário contido no arquivo, e para salvar o dicionário no arquivo.
...
def carregar_info() -> dict:
    """ Caso haja arquivo, carrega o dict contido nele e retorna.
